...
public class AllDevicesTabTest extends SeleniumTestBase {
    ...
    public void testAllDevicesTab() throws Exception {
        ...
        verifyEquals("2014-09-23", selenium.getText("//tbody[@id='table-all-devices']/tr[2]/td[7]"));
        ...
        verifyEquals("2014-09-23", selenium.getText("//tbody[@id='table-all-devices']/tr[3]/td[5]"));
        verifyEquals("stephanfellhofer", selenium.getText("//tbody[@id='table-all-devices']/tr[3]/td[6]"));
        ...
        verifyEquals("2014-09-23", selenium.getText("//tbody[@id='table-all-devices']/tr[6]/td[7]"));
        ...
        verifyEquals("2014-09-23", selenium.getText("//tbody[@id='table-all-devices']/tr[7]/td[5]"));
        verifyEquals("admin", selenium.getText("//tbody[@id='table-all-devices']/tr[7]/td[6]"));
